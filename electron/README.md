# FlowGate Electron Desktop App

This directory contains the Electron wrapper for FlowGate, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., flowgate-macos)
cp ../flowgate-macos ../flowgate
```
...
- Store database in `../data/flowgate.db`
...
### Database Location
- **Development**: `../data/flowgate.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/FlowGate/data/`
  - Windows: `%APPDATA%/FlowGate/data/`
  - Linux: `~/.config/FlowGate/data/`
