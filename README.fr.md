...
![flowgate](/web/default/public/logo.png)
...
<p align="center">
  <a href="https://raw.githubusercontent.com/Calcium-Ion/flowgate/main/LICENSE">
    <img src="https://img.shields.io/github/license/Calcium-Ion/flowgate?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/Calcium-Ion/flowgate/releases/latest">
    <img src="https://img.shields.io/github/v/release/Calcium-Ion/flowgate?color=brightgreen&include_prereleases" alt="version">
  </a><!--
  --><a href="https://hub.docker.com/r/ghcr.io/dinnelthai/flowgate">
    <img src="https://img.shields.io/badge/docker-dockerHub-blue" alt="docker">
  </a><!--
  --><a href="https://goreportcard.com/report/github.com/Calcium-Ion/flowgate">
    <img src="https://goreportcard.com/badge/github.com/Calcium-Ion/flowgate" alt="GoReportCard">
  </a>
</p>

<p align="center">
  <a href="https://trendshift.io/repositories/20180" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/20180" alt="QuantumNous%2Fflowgate | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>
  <br>
  <a href="https://hellogithub.com/repository/QuantumNous/flowgate" target="_blank">
    <img src="https://api.hellogithub.com/v1/widgets/recommend.svg?rid=539ac4217e69431684ad4a0bab768811&claim_uid=tbFPfKIDHpc4TzR" alt="Featured｜HelloGitHub" style="width: 250px; height: 54px;" width="250" height="54" />
  </a><!--
  --><a href="https://www.producthunt.com/products/flowgate/launches/flowgate?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-flowgate" target="_blank" rel="noopener noreferrer">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1047693&theme=light&t=1769577875005" alt="FlowGate - All-in-one AI asset management gateway. | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" />
  </a>
</p>
...
<p align="center">
  <a href="https://www.jetbrains.com/?from=flowgate" target="_blank">
    <img src="https://resources.jetbrains.com/storage/products/company/brand/logos/jb_beam.png" alt="JetBrains Logo" width="120" />
  </a>
</p>

<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=flowgate">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
```bash
# Cloner le projet
git clone https://github.com/QuantumNous/flowgate.git
cd flowgate
...
docker pull ghcr.io/dinnelthai/flowgate:latest

# Utilisation de SQLite (par défaut)
docker run --name flowgate -d --restart always \
  -p 3000:3000 \
  -e TZ=Asia/Shanghai \
  -v ./data:/data \
  ghcr.io/dinnelthai/flowgate:latest
...
### 📖 [Documentation officielle](https://docs.newapi.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/flowgate)
...
> [!TIP]
> **Dernière image Docker:** `ghcr.io/dinnelthai/flowgate:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `flowgate` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `flowgate` |
...
| [flowgate-horizon](https://github.com/Calcium-Ion/flowgate-horizon) | Version optimisée haute performance de FlowGate |
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=Calcium-Ion/flowgate&type=Date)](https://star-history.com/#Calcium-Ion/flowgate&Date)
...
### 💖 Merci d'utiliser FlowGate

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://docs.newapi.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/Calcium-Ion/flowgate/issues)** • **[Dernière version](https://github.com/Calcium-Ion/flowgate/releases)**
