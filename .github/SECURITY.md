...
To report a security issue, please use the GitHub Security Advisories tab to "[Open a draft security advisory](https://github.com/QuantumNous/flowgate/security/advisories/new)". This is the preferred method as it provides a built-in private communication channel.
...
When deploying and using FlowGate, we recommend following these security best practices:
