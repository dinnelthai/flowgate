...
import (
	...
	"github.com/QuantumNous/flowgate/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "flowgate:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "flowgate:channel_affinity_usage_cache_stats:v1"
)
