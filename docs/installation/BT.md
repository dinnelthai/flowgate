...
本文档提供使用宝塔面板 Docker 功能部署 FlowGate 的图文教程。
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/flowgate`
...
services:
  flowgate:
    image: calciumion/flowgate:latest
...
```bash
# 拉取最新镜像
docker pull calciumion/flowgate:latest
...
- [GitHub 仓库](https://github.com/QuantumNous/flowgate)
